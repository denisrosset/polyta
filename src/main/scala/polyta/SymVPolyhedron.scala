...
object SymVPolyhedron {
  @inline protected def build[V, @sp(Double) A](vertices0: Seq[V], rays0: Seq[V], symmetryGroup0: Grp[(Perm, Perm)])(implicit alg0: AlgVF[V, A]): SymVPolyhedron[V, A] =
  ...
  def apply[V, @sp(Double) A](vertices: Seq[V], rays: Seq[V], symmetryGroup: Grp[(Perm, Perm)])(implicit alg: AlgVF[V, A]): SymVPolyhedron[V, A] =
